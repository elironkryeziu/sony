    ...
    <div class="row justify-content-center">
        ...
        <p>Data prej:<p>
            ...
            @foreach ($sonys as $sony)
                @if ($sony->number == $selected_sony)
                    <option value="{{ $sony->number }}" selected>Sony {{ $sony->number }}</option>
                @else
        ...
        <thead>
            ...
            <th scope="col" class="text-center">Sony</th>
            <th scope="col" class="text-center">Persona</th>
            <th scope="col" class="text-center">Pagesa</th>
            <th scope="col" class="text-center">Starti</th>
            <th scope="col" class="text-center">Finishi</th>
            <th scope="col" class="text-center">Minutat</th>
            <th scope="col" class="text-center">Puntori</th>
        ...
        @foreach ($faturat as $fatura)
            ...
            <td class="text-center font-weight-bold">
                ...
                {{ $fatura->sony_id }}</td>
            <td class="text-center">{{ $fatura->type }}</td>
            <td class="text-center">{{ $fatura->price }} €</td>
            <td class="text-center">{{ $fatura->startTime }}</td>
            <td class="text-center">{{ $fatura->finishTime }}</td>
            <td class="text-center">{{ $fatura->minutes }}</td>
            <td class="text-center">{{ $fatura->user->name }}</td>
            <td class="text-center">{{ $fatura->created_at }}</td>
